          ...
          <form onSubmit={handleCreate} className="space-y-5">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="w-full bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                required
              />
